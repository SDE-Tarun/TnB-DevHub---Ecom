...
<button
  class="cursor-pointer text-black flex gap-2 items-center bg-white px-4 py-2 rounded-lg font-medium text-lg hover:bg-zinc-300 transition-all ease-in duration-200"
>
