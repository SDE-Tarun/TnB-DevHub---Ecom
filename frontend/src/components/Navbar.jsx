...
import { useAuth } from "../context/AuthContext";
import HeaderDashed from "./HeaderDashed"; // Assuming you are using this component to display the username
        ...
        <main className="col-12 d-flex justify-content-between align-items-center">
          ...
          <div className="right d-flex align-items-center gap-1 gap-sm-3">
            <div className="icons d-flex gap-1 gap-sm-3">
              ...
              {!user && (
                <NavLink
                  className="login-link text-decoration-none mt-2"
                  to="/login"
                  data-bs-toggle="tooltip"
                  data-bs-placement="bottom"
                  title="Login"
              ...
              {user && (
                <button
                  onClick={handleLogout}
                  className="group flex items-center justify-start w-11 h-11 bg-red-400 rounded-full cursor-pointer relative overflow-hidden transition-all duration-200 shadow-lg hover:w-32 hover:rounded-lg active:translate-x-1 active:translate-y-1"
                >
                  ...
                  <div className="absolute right-5 transform translate-x-full opacity-5 text-['#000000'] text-medium font-semibold transition-all duration-300 group-hover:translate-x-0 group-hover:opacity-100">
                    Logout
                  </div>
                </button>
              )}
